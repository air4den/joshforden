    ...
    return (
        <div className="about-card">
            <div className="about-card-text">
                ...
                <p>💥 As an engineer, I build software that solves problems and provides value to consumers and businesses.</p>
                <p>💬 Let's get it touch! Shoot me an email: <span id="email">{emailLink}</span></p>
            </div>
